...
- 在 wsl2 中开发的注意事项
  ...
  - 解决方案[参考](https://www.reddit.com/r/bashonubuntuonwindows/comments/c48yej/wsl_2_react_not_reloading_with_file_changes/) 及 [相关issue](https://github.com/microsoft/WSL/issues/4169)。
    - 打开资源管理器，在地址栏输入 `\\wsl$` ，将看到 wsl2 安装的所有 linux 发行版。
    - 如我们安装了 Ubuntu，则能看到 Ubuntu 文件夹。点击进去，在任意非 /mnt 目录下存放你的代码(建议放在 /root 下)